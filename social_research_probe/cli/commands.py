"""Command names supported by the command-line interface.
This module defines the canonical string values for CLI commands. Use these
enum values instead of raw strings when registering parsers, dispatching
handlers, or referencing commands in tests.
"""
