"""Shared types for the LLM runner abstraction.

Kept in a separate module so multiple services (ensemble, corroboration,
summary) can import without introducing circular dependencies.
"""
