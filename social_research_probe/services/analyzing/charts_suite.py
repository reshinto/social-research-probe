"""Composes the per-chart-type renderers from technologies/charts into a
full chart suite for one scored-items dataset.

Lives in services/ because it orchestrates multiple technology calls and
applies presentation concerns (path annotation in caption). Pure technology
renderers stay in technologies/charts/ and produce a single chart each.
"""
