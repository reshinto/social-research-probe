"""Per-item trust/trend/opportunity computation from raw items + engagement metrics.

Lives in services/scoring/ because the math composes platform-agnostic technologies
in technologies/scoring/. Pipelines call score_items() to get fully scored, ranked items.
"""
