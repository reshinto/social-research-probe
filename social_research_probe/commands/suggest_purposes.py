...
def _build_prompt(existing: list[str], count: int) -> str:
    ...
    from social_research_probe.technologies.llms.prompts import SUGGEST_PURPOSES_PROMPT
...
def _call_llm(prompt: str, runner: str) -> dict:
    ...
    from social_research_probe.technologies.llms.schemas import PURPOSE_SUGGESTIONS_SCHEMA
