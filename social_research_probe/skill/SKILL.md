...
When `llm.runner = none`, use the host LLM for the skill-only reasoning steps: classify natural-language research requests, summarize sections 1-9 from the packet/report, and author sections 10-11 when the CLI leaves them blank.
