...
def render_full(
    ...
    s10 = packet.get("compiled_synthesis") or "_(LLM synthesis not stored in this packet)_"
    s11 = packet.get("opportunity_analysis") or "_(LLM synthesis not stored in this packet)_"
