...
@contextmanager
def _full_schema_conn() -> Iterator[sqlite3.Connection]:
...
class TestFreshSchema:
    def test_fresh_schema_has_claims_table(self) -> None:
        with _full_schema_conn() as conn:
            rows = conn.execute(
