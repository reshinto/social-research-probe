...
| 4 | Delete the `supports_agentic_search` check in `LLMSearchBackend.health_check` | [corroboration/llm_search.py](../../social_research_probe/corroboration/llm_search.py) | `test_local_runner_does_not_support_agentic_search` |
| 5 | Wire `llm_search` to always use Gemini regardless of active runner | [corroboration/llm_search.py](../../social_research_probe/corroboration/llm_search.py) | `test_active_runner_claude_drives_agentic_search` |
